...
with col1:
    ...
    if Get_data or st.session_state.Get_state:
        ...
        api_version = 'v3'
        api_key = 'AIzaSyB0etMrNHWub3xj8nPgUMrGBcw1zWBdMUgpython '
        ...
        client = pymongo.MongoClient(
            'mongodb+srv://preranaraj:guvi1234@cluster0.1960q02.mongodb.net/?retryWrites=true&w=majority')
...
with col2:
    ...
    if Migrate or st.session_state_migrate_sql:
        ...
        engine = create_engine('mysql+mysqlconnector://root:guvi@localhost/youtube_db', echo=False)
...
connect_for_question = pymysql.connect(host='localhost', user='root', password='guvi', db='youtube_db')
